      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          ...
          <div className="hidden md:flex items-center space-x-8">
            ...
            <Link
              to="/admin"
              className="px-4 py-2 bg-crocs-green text-white rounded-lg hover:bg-crocs-dark transition-all duration-200 font-medium"
            >
              Admin
            </Link>
          </div>
          ...
          >
            <div className="px-4 py-4 space-y-2">
              ...
              <Link
                to="/admin"
                onClick={() => setIsOpen(false)}
                className="block px-4 py-2 bg-crocs-green text-white rounded-lg text-center font-medium"
              >
                Admin
              </Link>
            </div>
