...
import { Phone, Mail, MapPin, MessageCircle, Instagram, Facebook, Twitter, Send } from 'lucide-react'
...
export default function Contact() {
  ...
  const handleWhatsApp = () => {
    const message = `Hi! I have a question about Crocs by Dero.`
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            >
              ...
              <div className="space-y-6">
                ...
                <a
                  href="mailto:info@crocsbydero.com"
                  className="flex items-center space-x-4 p-4 bg-white rounded-xl shadow-md hover:shadow-lg transition-all duration-200 group"
                >
                  <div className="p-3 bg-crocs-green/10 rounded-lg group-hover:bg-crocs-green transition-colors">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">info@crocsbydero.com</p>
                  </div>
                </a>
